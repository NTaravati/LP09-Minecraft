...
# INITIATE SETUP
# > UPDATE SERVER
while ! echo y | apt-get update; do sleep 10 && apt update; done
while ! echo y | apt-get install -y software-properties-common; do sleep 10 && apt install -y software-properties-common; done
while ! echo y | apt-get install -y openjdk-11-jre-headless; do sleep 10 && apt install openjdk-11-jre-headless; done
while ! echo y | apt-get install -y gcc; do sleep 10 && apt install -y gcc; done
...
chown -R root:root /etc/systemd/system/minecraft.service
